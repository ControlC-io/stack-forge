...

  {
    ...
    options: [
      ...
      },
      {
        ...
        description: L('Build y tests en cada push.', 'Build and tests on every push.', 'Build et tests à chaque push.'),
        spec: 'GitHub Actions running typecheck, build and tests on every push',
        locked: true,
      },
    ],
  },
